...
/** <b>Classe FilterDescription: </b><br><br>
 * Tale classe filtra i friends valutando se la loro descrizione non e' vuota.
 * @author Cristian Di Silvetre
 */
public class FilterDescription extends Filter {
	
	/** Tale metodo valuta se la descrizione di un singolo friend e' vuota o meno.
